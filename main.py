...
def special(char_name: str, char_class: str) -> str:
    """Примененине специального умения."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Тренировка. Знакомство с управлением."""
    if char_class == 'warrior':
...
def choice_char_class():
    """Позволяет выбрать персонажа. Выводит характеристики персонажа."""
    approve_choice = None
    char_class = None
...
def main() -> None:
    """Позволяет ввести имя персонажа."""
    run_screensaver()
